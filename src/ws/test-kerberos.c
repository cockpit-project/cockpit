                   ...
                   gconstpointer data)
{
  ...
  cockpit_test_setenv ("COCKPIT_TEST_KEEP_PATH", "1");
  cockpit_test_setenv ("COCKPIT_TEST_KEEP_KTAB", "1");
