...
rm -rf /usr/share/cockpit/domain/ /usr/share/cockpit/system/ /usr/share/cockpit/users/ /usr/share/cockpit/dashboard/

ln -sf /container/simple-shell /usr/share/cockpit/
...
chmod 775 /container/simple-shell
