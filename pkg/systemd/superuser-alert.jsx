...
export class SuperuserAlert extends React.Component {
    constructor () {
        ...
        this.state = { dismissed: false, show_unlock_dialog: false };
    }
    ...
    render () {
        const actions =
            <>
                ...
                <AlertActionCloseButton onClose={() => this.setState({ dismissed: true })} />
            </>;
        ...
        return (
            <>
                <Alert hidden={this.superuser.Current != "none" || this.state.dismissed}
                       variant="info"
                       action={actions}
