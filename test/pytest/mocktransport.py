...
class MockTransport(asyncio.Transport):
    ...
    def send_json(self, channel_: str, **kwargs: Any) -> None:
    ...
    def send_init(self, version: int = 1, host:  str = MOCK_HOSTNAME, **kwargs: Any) -> None:
    ...
    def send_open(self, payload: str, channel: 'str | None' = None, **kwargs: Any) -> str:
        if channel is None:
