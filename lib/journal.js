...
(function (root, factory) {
    ...
    if (typeof exports === 'object') {
        module.exports = factory(
            require('cockpit'),
            require('mustache'),
            require('raw!journal_day_header.mustache'),
            require('raw!journal_line.mustache'),
            require('raw!journal_reboot.mustache')
        );
...
}(this, function(cockpit, Mustache, day_header_template, line_template, reboot_template) {
    "use strict";
