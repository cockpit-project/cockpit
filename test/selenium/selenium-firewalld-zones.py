...
class FirewalldZones(SeleniumTest):
    ...
    def add_custom_zone(self, zone, ip_range):
        ...
        self.wait_css(".zone-section[data-id='{}']".format(self.zone_custom))

    def remove_custom_zone(self, zone):
        self.click(self.wait_css(".zone-section[data-id='{}'] .zone-section-buttons button.btn-danger".format(self.zone_custom)))
    ...
    def testDefaultZoneListing(self):
        ...
        self.wait_css(".zone-section[data-id='{}']".format(self.zone_default))
    ...
    def testAddServiceToCustomZone(self):
        ...
        self.click(self.wait_css(".zone-section[data-id='{}'] .add-services-button:enabled".format(self.zone_custom)))
        ...
        self.click(self.wait_xpath("//div[@id='add-services-dialog']//button[contains(text(), 'Add Services')]",
                                   cond=clickable))
        self.wait_id("firewall")
        self.click(self.wait_css(".zone-section[data-id={}] tr[data-row-id={}]".format(self.zone_custom, service)))
