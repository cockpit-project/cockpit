                     ...
                     GDBusMethodInvocation *invocation)
{
   ...
   * is installed unchanged.  Unfortunately, not all versions of
   * newusers support the --crypt-method option.  In that case, we fix
   * up the password afterwards via chpasswd.
   *
