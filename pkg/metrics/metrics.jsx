    ...
    render() {
        ...
        const graphs = Object.keys(this.props.selectedVisibility).filter(itm => this.props.selectedVisibility[itm]).map(resource => {
            ...
            if (this.props.events) {
                ...
                graph = <div key={resource} className={"compressed polygons" + (have_sat ? " polygons-sat" : "")} style={{ "--utilization": first["use_" + resource] || 0, "--saturation": first["sat_" + resource] || 0 }}>
                    <div className="polygon-use" />
                    <div className="polygon-border" />
                    { have_sat && <div className="polygon-sat" /> }
                </div>;
            }
