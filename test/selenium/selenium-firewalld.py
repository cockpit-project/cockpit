...
class FirewalldPage(FirewalldBasePage):
    ...
    def testCockpitService(self):
        self.click(self.wait_css(".zone-section[data-id=[public] tr[data-row-id=cockpit]"))
    ...
    def testAddService(self):
        ...
        self.click(self.wait_id("{}-add-services-button')".format(self.zone_default)))
        ...
        self.wait_id("firewall")
        self.click(self.wait_css(".zone-section[data-id={}] tr[data-row-id={}]".format(self.zone_default, service)))
    ...
    def testRemoveService(self):
        ...
        self.assertIn(service, self.machine.execute("sudo firewall-cmd --list-services"))
        self.click(self.wait_css(".zone-section[data-id={}] tr[data-row-id={}]".format(self.zone_default, service)))
        self.click(self.wait_id("{}-{}-delete-button".format(self.zone_default, service), cond=clickable))
