...
define([
    ...
    PageContainerDetails.prototype = {
        ...
        update: function() {
            ...
            $('#container-details-ipaddr').text(util.render_container_ipaddr(info.NetworkSettings.IPAddress));
            $('#container-details-ipprefixlen').text(util.render_container_ipprefixlen(String(info.NetworkSettings.IPPrefixLen)));
            $('#container-details-gateway').text(util.render_container_gateway(info.NetworkSettings.Gateway));
            $('#container-details-macaddr').text(util.render_container_macaddr(info.NetworkSettings.MacAddress));
