...
import { TruncateMiddle } from "../lib/cockpit-components-truncate.jsx";
                ...
                <Card key={key} onClick={onClick}
                    ...
                    <CardBody>
                        <Split hasGutter>
                            ...
                            <SplitItem isFilled><strong><TruncateMiddle content={name} /></strong>{info}</SplitItem>
