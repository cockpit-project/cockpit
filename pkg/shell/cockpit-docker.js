...
function render_container (client, $panel, filter_button, prefix, id, container, danger_mode) {
    ...
    if (!tr.length) {
        ...
        tr = $('<tr id="' + prefix + id + '">').append(
            ...
            $('<td class="container-col-danger cell-buttons">').append(btn_delete),
            $('<td class="container-col-actions cell-buttons">').append(btn_play, btn_stop, img_waiting));
    ...
    $(row[6]).children("button").attr("disabled", !danger_mode);
    $(row[6]).on("click", function(event) {
        return false;
    });
...
PageContainers.prototype = {
    ...
    toggle_danger: function(val) {
        ...
        $("#containers-containers .btn-danger").attr("disabled", !self.danger_enabled);
    },
...
PageImageDetails.prototype = {
    ...
    toggle_danger: function(val) {
        ...
        $("#image-details-containers .btn-danger").attr("disabled", !self.danger_enabled);
    },
