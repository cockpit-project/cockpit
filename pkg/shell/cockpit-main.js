...
function hosts_init() {
    ...
    function add_host(addr, proxy) {
        var client = cockpit.dbus("internal", { host: addr, bus: "session" });
    ...
    var internal = cockpit.dbus("internal", { host: "localhost", bus: "session" });
    host_proxies = internal.proxies("com.redhat.Cockpit.Machine",
