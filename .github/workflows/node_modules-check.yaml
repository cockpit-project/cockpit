    ...
    steps:
      ...
      - name: npm install
        ...
        run: |
          ...
          container="$(sudo docker create -u node -w /home/node/work node:14 npm install --ignore-scripts)"
          tar --create --owner node --group node work | sudo docker cp - "${container}:/home/node"
