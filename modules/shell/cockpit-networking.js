 ...
 * cycles.  In general, it follows the NetworkManager D-Bus API.
 *
 * For example,
 *
 ...
 *
 * In other words, any change from one version of the data structure
 * to the next represents a real change in the state of
 * NetworkManager.
 *
