    ...
    render() {
            ...
            swapProgress = (
                <Tooltip content={ cockpit.format(_("$0 total"), cockpit.format_bytes(swapTotal)) } position="bottom">
                    <Progress
                        ...
                        className="pf-m-sm"
                        min={0} max={swapTotal}
                        variant={swapUsedFraction > 0.9 ? ProgressVariant.danger : swapUsedFraction > 0.79 ? ProgressVariant.warning : null}
        ...
        if (this.state.cpuCoresUsed.length > 1) {
            ...
            topCore = <Progress
                           ...
                           min={0} max={100}
                           variant={ top_cores[0][1] > 90 ? ProgressVariant.danger : top_cores[0][1] > 79 ? ProgressVariant.warning : ProgressVariant.info }
                    ...
                    <CardBody>
                        <div className="progress-stack-no-space">
                            <Progress
                                ...
                                min={0} max={100}
                                variant={ this.state.cpuUsed > 90 ? ProgressVariant.danger : this.state.cpuUsed > 79 ? ProgressVariant.warning : null }
                                title={ num_cpu_str }
                                label={ cpu_label } />
                            {topCore}
                            {allCpus}
                        ...
                        <div className="progress-stack">
                            <Tooltip
                                ...
                                <Progress
                                    ...
                                    className="pf-m-sm"
                                    min={0} max={memTotal}
                                    variant={memUsedFraction > 0.9 ? ProgressVariant.danger : memUsedFraction > 0.79 ? ProgressVariant.warning : null}
                            ...
                            this.state.mounts.map(info => {
                                let progress = (
                                    <Progress
                                        ...
                                        className="pf-m-sm"
                                        variant={info.use > 90 ? ProgressVariant.danger : info.use > 79 ? ProgressVariant.warning : null}
                                        title={info.target}
