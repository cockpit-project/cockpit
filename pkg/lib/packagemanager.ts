...
import { PackageManager, Enum, UnsupportedError, NotFoundError } from './_internal/packagemanager-abstract';
...
export async function getPackageManager(): Promise<PackageManager> {
    ...
    if (unsupported)
        throw new UnsupportedError("Unsupported package manager");
