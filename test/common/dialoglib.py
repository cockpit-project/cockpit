...
class DialogHelpers:
    def __init__(self, b: testlib.Browser, pfx: str):
        self.browser = b
        self.pfx = pfx

    def id(self, path: str, tag: str) -> str:
        return f"{self.pfx} [data-ouia-component-id='dialog-{tag}-{path}']"
    ...
    def error(self) -> str:
        return f"{self.pfx} [data-ouia-component-id='dialog-error-message']"

    def apply_button(self) -> str:
        return f"{self.pfx} [data-ouia-component-id='dialog-apply']"

    def cancel_button(self) -> str:
        return f"{self.pfx} [data-ouia-component-id='dialog-cancel']"
