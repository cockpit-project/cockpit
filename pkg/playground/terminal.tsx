...
import { Page, PageSection, ToggleGroup, ToggleGroupItem, Button, Split, SplitItem } from '@patternfly/react-core';
        ...
        <Page isContentFilled className="no-masthead-sidebar">
            <PageSection isFilled hasBodyWrapper={false}>
                ...
                <div id="terminal" style={{ height: "100%" }}>
                    <Terminal parentId="terminal" state={states[tab]} />
                </div>
            </PageSection>
        </Page>
    );
