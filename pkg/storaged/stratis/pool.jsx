...
function PoolPassphrase(tag, pool, main, stored_keydescs) {
    ...
    const need_passphrase = clevis_infos.length == 0 && !have_stored_passphrase;
...
async function add_disks(pool) {
    ...
    dialog_open({
        ...
        Fields: [
            ...
            ...(is_v1_pool
                ? [PoolPassphrase("pool_passphrase", pool, _("Adding blockdevices requires unlocking the pool."), stored_keydescs)]
                : []),
        ],
        Action: {
            Title: _("Add"),
        ...
        dialog_open({
            ...
            Action: {
                ...
                action: async vals => {
                    ...
                    return await with_stored_passphrase(client, info.keydesc, vals.old_passphrase,
