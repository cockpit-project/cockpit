...
export class ShellState extends EventEmitter<ShellStateEvents> {
    ...
    page_status: { [host: string]: { [page: string]: ShellPageStatus } } = { };

    #init_page_status() {
        sessionStorage.removeItem("cockpit:page_status");
    }

    #notify_page_status(host: string, page: string, status: ShellPageStatus) {
    ...
    #init_router() {
        const callbacks = {
             ...
             */
            handle_notifications: (host: string, page: string, data: { page_status?: ShellPageStatus }) => {
