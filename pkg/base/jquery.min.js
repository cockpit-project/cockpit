...
(function(e){"use strict";function n(e,i,t){var l,r,o,d,a;var u,f,h;if(t>0){if(e.nodeType!=i.nodeType||e.nodeType!=1&&e.nodeType!=3){e.parentNode.replaceChild(i.parentNode.removeChild(i),e);return}else if(e.nodeType==3){if(e.nodeValue!=i.nodeValue)e.nodeValue=i.nodeValue;return}}if(e.nodeType==1){if(t>0){h={};u=e.attributes;for(a=u.length-1;a>=0;a--)h[u[a].name]=u[a].value;for(a=i.attributes.length-1;a>=0;a--){f=i.attributes[a];if(h[f.name]!==f.value)e.setAttribute(f.name,f.value);delete h[f.name]}for(a in h)e.removeAttribute(a)}l=e.firstChild;r=i.firstChild;for(;;){o=l;d=r;while(o&&o.nodeType!=1&&o.nodeType!=3)o=o.nextSibling;while(d&&d.nodeType!=1&&d.nodeType!=3)d=d.nextSibling;if(!o&&!d){break}else if(!o){l=null;r=d.nextSibling;e.appendChild(i.removeChild(d))}else if(!d){l=o.nextSibling;r=null;e.removeChild(o)}else{l=o.nextSibling;r=d.nextSibling;n(o,d,(t||0)+1)}}}}e.fn.amend=function i(t,l){this.each(function(){var i=e("<div>").html(t);n(this,i[0],0)});return this}})(jQuery);