...
class KubernetesCase(testlib.MachineCase):
    ...
    def start_kubernetes(self):
        ...
        if self.machine.image in ["fedora-29", "fedora-30", "fedora-testing"]:
            self.machine.execute("""
...
class KubernetesCommonTests(VolumeTests):
    ...
    def testNodes(self):
        ...
        b.wait_in_text("modal-dialog .modal-body", "a-mynode")
        b.click("modal-dialog .btn-danger")
        b.wait_not_present("modal-dialog .dialog-wait-ct")
        b.wait_not_present("modal-dialog")
        b.wait_present(".nodes-listing")
        ...
        b.wait_in_text("modal-dialog .modal-body", "b-mynode")
        b.click("modal-dialog .btn-danger")
        b.wait_not_present("modal-dialog .dialog-wait-ct")
        b.wait_not_present("modal-dialog")
        ...
        b.click(".content-filter button.btn-danger")
        b.wait_in_text("modal-dialog .modal-body", "c-mynode")
        b.wait_in_text("modal-dialog .modal-body", "d-mynode")
        b.wait_not_in_text("modal-dialog .modal-body", "127.0.0.1")
        b.click("modal-dialog .btn-cancel")
        b.wait_not_present("modal-dialog")
