        ...
        function($q, select, loader, policy) {
            ...
            function shareImages(project, accessPolicy) {
                ...
                if (accessPolicy === "anonymous")
                    ...
                    return policy.removeFromRole(project, sharedRole, anonSubject).then(function() { return policy.addToRole(project, sharedRole, sharedSubject); });
                else
                    return policy.removeFromRole(project, sharedRole, anonSubject).then(function() { return policy.removeFromRole(project, sharedRole, sharedSubject); });
            }
