...
export const CreateTimerDialogBody = ({ owner, current }) => {
    ...
    return (
        <Modal id="timer-dialog"
           ...
           title={!current ? _("Create timer") : _("Edit timer")}
           footer={
               <>
            ...
            <Form isHorizontal onSubmit={onSubmit}>
                {current && !current.delay && <FormAlert>
                    <Alert variant="danger" title={_("Failed to get the current starting conditions for the timer")} isInline />
                </FormAlert>}
                {current && !current.command && <FormAlert>
                    <Alert variant="danger" title={_("Failed to get the current command for the timer")} isInline />
                </FormAlert>}
