    ...
    steps:
      ...
      - name: npm install
        ...
        run: |
          ...
          container="$(sudo docker create -u node -w /home/node/work node:14 ls -Rl /home/node)" #npm install --ignore-scripts)"
          tar --create --owner 1000:1000 --group 1000:1000 work | sudo docker cp -a - "${container}:/home/node"
          sudo docker start -a "${container}" 2>&1 | tee work/npm-install-log
          sudo docker cp "${container}:/home/node/work" - | tar --get work/node_modules
