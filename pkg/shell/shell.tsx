...
const Shell = () => {
    ...
    useEvent(host_modal_state as unknown as cockpit.EventSource<cockpit.EventMap>, "changed");
...
interface CockpitWindow extends Window {
    features?: object;
}
...
function init() {
    ...
    (window as CockpitWindow).features = {
